...
import com.inbrain.sdk.model.Survey; import com.inbrain.sdk.model.InBrainSurveyReward;
...
public class FlutterInbrainPlugin implements FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    InBrainCallback callback = new InBrainCallback() {
        ...
        @Override
        public void surveysClosed(boolean closed, List<InBrainSurveyReward> array) {
    ...
    public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
        if (call.method.equals("init")) {
            if (call.argument("apiClientId") != null && call.argument("apiSecret") != null
                    && call.argument("isS2S") != null && call.argument("userId") != null) {
                String apiClientId = call.argument("apiClientId");
                String apiSecret = call.argument("apiSecret");
                boolean isS2S = call.argument("isS2S");
                String user_id = call.argument("userId");
